...
using nats_cli_framework.Properties;

namespace nats_cli_framework
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            if (!ScanArg.DisplayHelp)
            {
             ...
             string GetDateTime() { return string.Concat(DateTime.Now.ToShortDateString(), " ", DateTime.Now.ToString("HH:mm:ss fff")); }

             string ArgsToArg(string[] args12)
            { return string.Join(" ", args12); }
